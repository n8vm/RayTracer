...
public:
    ...
    virtual Color Shade(const Rays &diffRays, const HitInfo &hInfo, const LightList &lights, int bounceCount, IlluminationType directType, IlluminationType indirectType) const=0;
