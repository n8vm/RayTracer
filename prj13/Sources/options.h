...
#define DIRECT_TYPE IlluminationType::NO_ILLUMINATION
#define INDIRECT_TYPE IlluminationType::PHOTON
#define INITIAL_PATH_TRACES 2

// Path Tracing Settings
#define INDIRECT_SAMPLES 4
...
#define CAUSTIC_REFRACTION_SCALE (/*4.0 * M_PI*/1.0)
#define CAUSTIC_REFLECTION_SCALE (/*4.0 * M_PI*/1.0)
